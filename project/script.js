...
async function main() {
  ...
  var fstop = Number(document.getElementById("fstop").value);

  var uniforms_f = new Float32Array([aspect, gamma, fstop, fdist]);
  var frame_num = 0;
...
const lightIndicesBuffer = device.createBuffer({
  ...
  document.getElementById("fdist").addEventListener("change", (e) => {
